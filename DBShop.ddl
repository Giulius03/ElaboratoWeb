...
create table ARTICOLI (
     ...
     DescrizioneITA varchar(250) not null,
     DescrizioneENG varchar(250) not null,
...
("Order delivered", "Your order has been just delivered, enjoy it!\nIf you want, you can leave a review of the product(s) you ordered. We hope it will be good!\nCan't wait for your next order, bye!", "Ordine consegnato", "Il tuo ordine è stato appena consegnato, goditelo!\nSe vuoi, puoi lasciare una recensione del/i prodotto/i che hai ordinato. Speriamo che sia buona!\nTi aspettiamo per un altro ordine, ciao!",
("Tickets purchased", "You just bought tickets for the next game! We wish you a good show.\nP.S. Always go Bugs Burnley!", "Biglietti acquistati", "Hai appena acquistato dei biglietti per la prossima partita! Ti auguriamo un bello spettacolo!\nP.S. Sempre forza Bugs Burnley!");
